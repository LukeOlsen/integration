...
from .sapb1api import InfoAPI, CodeAPI, OrdersAPI, QuoationAPI, ContactsAPI, ShipmentsAPI, ItemsAPI, PricesAPI
...
api_v1.add_resource(QuoationAPI, '/quoation/<function>')
