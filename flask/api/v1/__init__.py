...
from .sapb1api import InfoAPI, CodeAPI, OrdersAPI, QuotationAPI, ContactsAPI, ShipmentsAPI, ItemsAPI, PricesAPI
...
api_v1.add_resource(QuotationAPI, '/quotation/<function>')
