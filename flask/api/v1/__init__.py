...
from .sapb1api import InfoAPI, CodeAPI, OrdersAPI, QuotesAPI, ContactsAPI, ShipmentsAPI, ItemsAPI, PricesAPI, CustomersAPI, Login
...
api_v1.add_resource(CustomersAPI, '/customers')
